...
> [!NOTE]
> `System.Text.Json` ships with .NET 10 — no extra package needed for JSON serialization.
...
[appsettings.json](file:///c:/Learn%20C%23/Build%20Real%20.NET%20Data%20Services/appsettings.json)
...
> [!TIP]
> In production, you'd have `appsettings.Development.json` and `appsettings.Production.json` for environment-specific overrides.

---

### 2. `Models/Post.cs` — API Response Model

[Post.cs](file:///c:/Learn%20C%23/Build%20Real%20.NET%20Data%20Services/Models/Post.cs)
...
[ProcessedPost.cs](file:///c:/Learn%20C%23/Build%20Real%20.NET%20Data%20Services/Models/ProcessedPost.cs)
...
[ApiService.cs](file:///c:/Learn%20C%23/Build%20Real%20.NET%20Data%20Services/Services/ApiService.cs)
...
> [!IMPORTANT]
> In production, you'd use `IHttpClientFactory` instead of `new HttpClient()` to avoid socket exhaustion. This demo keeps it simple intentionally.

---

### 5. `Services/FileService.cs` — File Output

[FileService.cs](file:///c:/Learn%20C%23/Build%20Real%20.NET%20Data%20Services/Services/FileService.cs)
...
[Program.cs](file:///c:/Learn%20C%23/Build%20Real%20.NET%20Data%20Services/Program.cs)
...
> [!TIP]
> This project uses the same configuration and logging patterns as ASP.NET Core. Mastering them here transfers directly to web API development.
